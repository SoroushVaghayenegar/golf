...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-slate-100 p-4 sm:p-10 flex flex-col items-center font-[family-name:var(--font-geist-sans)]">
      <main className="w-full max-w-5xl flex flex-col gap-8">
        {/* Date Picker */}
        <section className="bg-white rounded-xl shadow p-4 flex flex-col sm:flex-row gap-6 items-center justify-between">
          ...
          {/* Players, Holes, Time Range - Placeholders */}

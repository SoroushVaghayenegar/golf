...
class Course {
    constructor(id, name, display_name, club_name, city, rating, external_api, external_api_attributes = {}, booking_visibility_days = 0) {
        this.id = id;
        this.name = name;
    ...
    static fromObject(obj) {
        ...
        return new Course(obj.id, obj.name, obj.display_name, obj.club_name, cityName, obj.rating, obj.external_api, obj.external_api_attributes || {}, obj.booking_visibility_days || 0);
    }

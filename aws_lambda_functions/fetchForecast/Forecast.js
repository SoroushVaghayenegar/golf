...
class Forecast {
    constructor(city_id, date, temperature_2m, wind_speed_10m, wind_gusts_10m, weather_code, precipitation_probability, cloud_cover, uv_index, precipitation) {
    ...
    static fromObject(obj) {
        ...
        return new City(obj.city_id, obj.date, obj.temperature_2m, obj.wind_speed_10m, obj.wind_gusts_10m, obj.weather_code, obj.precipitation_probability, obj.cloud_cover, obj.uv_index, obj.precipitation);
    }

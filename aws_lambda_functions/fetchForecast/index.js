...
const handler = async (event) => {
    ...
    const cities = citiesData.map(cityData => City_1.City.fromObject(cityData));
    ...
    const promises = cities.flatMap(city => {
        return (0, utils_1.fetchForecast)(city, startDate);
    });
    ...
    const upsertResult = await (0, utils_1.batchUpsertForecasts)(supabase, forecasts);
